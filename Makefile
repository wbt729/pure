...
# Project:  pure.pro
# Template: app
# Command: /usr/bin/qmake CONFIG+=debug_and_release -o Makefile pure.pro
#############################################################################
...
Makefile: pure.pro  /usr/share/qt/mkspecs/linux-g++/qmake.conf /usr/share/qt/mkspecs/common/unix.conf \
	...
	$(QMAKE) CONFIG+=debug_and_release -o Makefile pure.pro
